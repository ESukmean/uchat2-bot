...
fn test_auth_level_str() {
	assert_eq!(UChatAuthLevel::Admin.to_string(), "admin");
	assert_eq!(UChatAuthLevel::SubAdmin.to_string(), "subadmin");
	assert_eq!(UChatAuthLevel::Member.to_string(), "member");
	assert_eq!(UChatAuthLevel::Guest.to_string(), "guest");
	assert_eq!(UChatAuthLevel::None.to_string(), "");
}
#[test]
fn test_join_config() {
	...
	let auth: UChatAuthLevel = UChatAuthLevel::SubAdmin;
